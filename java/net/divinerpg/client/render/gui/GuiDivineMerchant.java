...
public class GuiDivineMerchant extends GuiContainer {
	
	private static final Logger logger = LogManager.getLogger();
	private IMerchant theIMerchant;
	private GuiDivineMerchant.ModMerchantButton nextRecipeButtonIndex;
	private GuiDivineMerchant.ModMerchantButton previousRecipeButtonIndex;
	...
	public void initGui() {
		...
		this.buttonList.add(this.nextRecipeButtonIndex = new GuiDivineMerchant.ModMerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true, texture));
		this.buttonList.add(this.previousRecipeButtonIndex = new GuiDivineMerchant.ModMerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false, texture));
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
            ...
            if (this.func_146978_c/*isPointInRegion*/(36, 24, 16, 16, par1, par2)) {
                this.renderToolTip(itemstack, par1, par2);
            }
            else if (itemstack1 != null && this.func_146978_c/*isPointInRegion*/(62, 24, 16, 16, par1, par2)) {
                this.renderToolTip(itemstack1, par1, par2);
            }
            else if (this.func_146978_c/*isPointInRegion*/(120, 24, 16, 16, par1, par2)) {
