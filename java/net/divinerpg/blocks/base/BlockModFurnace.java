...
public abstract class BlockModFurnace extends BlockContainer {
	...
	public void onBlockAdded(World w, int x, int y, int z) {
		...
		if(!w.isRemote) {
			...
			if(block.func_149698_L/*isFullBlock*/() && !block1.func_149698_L/*isFullBlock*/()) meta = 3;
			if(block1.func_149698_L/*isFullBlock*/() && !block.func_149698_L/*isFullBlock*/()) meta = 2;
			if(block2.func_149698_L/*isFullBlock*/() && !block3.func_149698_L/*isFullBlock*/()) meta = 5;
			if(block3.func_149698_L/*isFullBlock*/() && !block2.func_149698_L/*isFullBlock*/()) meta = 4;
	...
	public void breakBlock(World w, int x, int y, int z, Block b, int meta) {
		if(!keepInventory) {
			...
			if(entity != null) {
				...
				w.func_147453_f/*updateNeighborsAboutBlockChange*/(x, y, z, b);
			}
