...
public class BlockTwilightSapling extends BlockMod implements IGrowable {
    ...
    @Override
    public boolean func_149851_a/*canFertilize*/(World w, int x, int y, int z, boolean isClient) {
        return true;
    }

    @Override
    public boolean func_149852_a/*shouldFertilize*/(World w, Random random, int x, int y, int z) {
        return w.rand.nextFloat() < 0.45F;
    }

    @Override
    public void func_149853_b/*fertilize*/(World w, Random random, int x, int y, int z) {
