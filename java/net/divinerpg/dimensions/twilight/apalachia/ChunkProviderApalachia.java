...
public class ChunkProviderApalachia implements IChunkProvider{
	...
	private double[] initializeNoiseField(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		this.noise1 = this.noiseGen1.generateNoiseOctaves(this.noise1, var2, var3, var4, var5, var6, var7, var8*4, var10, var8*4);
		this.noise2 = this.noiseGen2.generateNoiseOctaves(this.noise2, var2, var3, var4, var5, var6, var7, var8*4, var10, var8*4);
		int var12 = 0;
		int var13 = 0;
		int var14 = 16 / var5;
	...
	@Override
	public ChunkPosition func_147416_a/*findClosestStructure*/(World var1, String var2, int var3, int var4, int var5) {
		return null;
	}
}