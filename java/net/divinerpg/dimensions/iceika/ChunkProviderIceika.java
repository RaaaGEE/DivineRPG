...
public class ChunkProviderIceika implements IChunkProvider {
	...
	public final void genBiomeTerrain(World w, Random rand, Block[] blocks, byte[] bytes, int i, int j, double d, BiomeGenBase b) {
		...
		byte b0 = (byte)(b.field_150604_aj/*topBlockMetadata*/ & 255);
					...
					if(block2 == IceikaBlocks.frozenStone) {
						if(k == -1) {
							if(l <= 0) {
								...
								block = b.topBlock;
								b0 = (byte)(b.field_150604_aj/*topBlockMetadata*/ & 255);
	...
	public Chunk provideChunk(int par1, int par2) {
		...
		this.caveGenerator.func_151539_a/*generate*/(this, this.worldObj, par1, par2, ablock);
	...
	@Override
	public ChunkPosition func_147416_a/*findClosestStructure*/(World w, String s, int x, int y, int z) {
		return null;
	}
